...
The project tries to understand the impact of the vertebrates' Defaunation in the Brazilian Atlantic forest. That is why we called it [**BEFAU-Biota**](https://souzayuri.shinyapps.io/biota/). Here the user can scroll through the app and check the information about the sampled areas, camera trap videos, fieldwork, and scientific publications, and interact with the data using a linear model.
